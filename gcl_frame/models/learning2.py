...
def xp_knn2(
	...
	from ged2 import compute_D_fitted2, compute_D_GH2020_2
	...
	for train_index, test_index in split_scheme:
		...
		cur_results['dis_app'] = y_app
		cur_results['y_test'] = y_test

		# Feed distances will all methods to compare
		edit_cost_fun = ('NON_SYMBOLIC' if descriptor == '1hot-dis' else 'CONSTANT')
		distances = {}
		distances['fitted2'] = compute_D_fitted2(
			G_app, y_app, G_test,
