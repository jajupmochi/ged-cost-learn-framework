...
def _optimize_costs_all(
	...
	from gcl_frame.models.optim_costs2 import _optimize_costs_solve
	from gcl_frame.models.optimizers.utils import _reconstruct_costs

	# Construct the triangle inequality constraints:
	from gcl_frame.models.optimizers.tri_rule import _construct_tri_rule_vecs
	tri_rule_list = _construct_tri_rule_vecs(sorted_label_pairs, tria_rule_mode)

	# Remove zero columns:
	if remove_zeros:
		from gcl_frame.models.optimizers.utils import _remove_zero_cols
	...
	if remove_zeros:
		from gcl_frame.models.optimizers.utils import _rejoin_zero_cols
