...
def _compute_D_gnn(
    ...
    # Compute Gram matrix:
    from gcl_frame.models.model_selection.gnn import model_selection_for_gnn
...
def compute_D_gcn(
    ...
    from gcl_frame.models.nn.gcn import GCN
    estimator = GCN
...
def compute_D_gat(
    ...
    from gcl_frame.models.nn.gat import GAT
    estimator = GAT
    return _compute_D_gnn(
            G_app, y_app, G_test, y_test, estimator, param_grid,
            mode, fit_test, y_distance=y_distance, **kwargs
